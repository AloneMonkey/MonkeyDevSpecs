Pod::Spec.new do |spec|
  ...
  spec.source           = { :git => "https://github.com/dalianmengwei/DeathlessLocation.git", :tag => 1.2}  #代码的git地址以及tag
  spec.source_files     = "DeathlessLocationPod/**/*.{h,m}"        #本地验证，表示当前目录以及子目录的所有h或m结尾的文件   如果发布到MonkeyPodSpecs需要填写git clone下来的对应的路径
