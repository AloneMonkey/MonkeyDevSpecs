Pod::Spec.new do |spec|
  ...
  spec.homepage         = "https://github.com/1061961387/LTBaiduNetDiskiPhone"   #Pod的地址
  ...
  spec.source           = { :git => "https://github.com/1061961387/LTBaiduNetDiskiPhone.git", :tag => spec.version.to_s }  #代码的git地址以及tag
