Pod::Spec.new do |spec|
  ...
  spec.source           = { :git => "https://github.com/WJustin/DingDingRevokeMessagePod.git", :tag => spec.version.to_s }  #代码的git地址以及tag
  spec.source_files     = "DingDingRevokeMessagePod/**/*.{h,m}"        #本地验证，表示当前目录以及子目录的所有h或m结尾的文件   如果发布到MonkeyPodSpecs需要填写git clone下来的对应的路径
  spec.public_header_files = "DingDingRevokeMessagePod/DingDingRevokeMessagePod.h"        #需要对外导出的头文件  此处为本地验证
