Pod::Spec.new do |spec|
  ...
  spec.homepage         = "https://github.com/AloneMonkey/WhatsAppPod"   #Pod的地址
  ...
  spec.source           = { :git => "https://github.com/AloneMonkey/WhatsAppPod.git", :tag => spec.version.to_s }  #代码的git地址以及tag
  spec.source_files     = "WhatsAppPod/**/*.{h,m}"        #本地验证，表示当前目录以及子目录的所有h或m结尾的文件   如果发布到MonkeyPodSpecs需要填写git clone下来的对应的路径
  spec.public_header_files = "WhatsAppPod/WhatsAppPod.h"        #需要对外导出的头文件  此处为本地验证
